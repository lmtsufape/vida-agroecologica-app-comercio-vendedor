...
class AlertDialogComprovante extends StatelessWidget {
  const AlertDialogComprovante({Key? key, required this.title, required this.body, required this.viewText, this.view, this.download, this.downloadText, required this.viewColor, required this.downloadColor}) : super(key: key);
